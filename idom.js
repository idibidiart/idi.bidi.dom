			...
			for (var n = 0; n < nestedCommentNodes.length; n++) {
				...
				if (id) {
					...
					if (linkedNodeIDList.indexOf(id) != -1) {
						...
						err.message = "cannot link the same node more than once into the same host node: use idom$cloneBase('version suffix') to create a new version of the base node before linking (coming in v0.08)";
